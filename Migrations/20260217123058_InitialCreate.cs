        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FilePathOrUrl = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScreenTimeSeconds = table.Column<double>(type: "double", nullable: false),
                    ScrollDepthPercent = table.Column<double>(type: "double", nullable: false),
                    CompletionPercent = table.Column<double>(type: "double", nullable: false),
                    QuizScorePercent = table.Column<double>(type: "double", nullable: false),
                    ProgressPercent = table.Column<double>(type: "double", nullable: false),
                    IsLowEngagementAlert = table.Column<bool>(type: "tinyint(1)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProgressTrackings_Materials_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "Materials",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProgressTrackings_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProgressTrackings_Topics_TopicId",
                        column: x => x.TopicId,
                        principalTable: "Topics",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionText = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OptionA = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OptionB = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OptionC = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OptionD = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CorrectOption = table.Column<string>(type: "varchar(1)", maxLength: 1, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuizId = table.Column<int>(type: "int", nullable: false),
                    StudentId = table.Column<int>(type: "int", nullable: false),
                    ScorePercent = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAtUtc", "FullName", "IsApproved", "IsPhoneVerified", "PasswordHash", "PhoneNumber", "Role" },
                values: new object[] { 1, new DateTime(2026, 2, 17, 12, 30, 54, 733, DateTimeKind.Utc).AddTicks(6039), "System Admin", true, true, "KVgDUryHesL2qs8B56d/1g==.ppWak9MKg7IhcC8FxEazFukkmLvvrotAkBYKnfjpL0c=", "9999999999", 1 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgressTrackings_MaterialId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgressTrackings_SubjectId",
                table: "ProgressTrackings",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_ProgressTrackings_TopicId",
                table: "ProgressTrackings",
                column: "TopicId");
